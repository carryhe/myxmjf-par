...
<head>
    ...
    <script type="text/javascript" src="${ctx}/myjs/invest.list.js"></script>
</head>
...
<div class="list_container">
    ...
    <table class="list_table">
        ...
        <tr class="table_header">
            <th style="width: 196px;" id="itemRate" class="order_item ketou" data-name="item.item_rate">预期年化收益
                <!--<span class="order"></span>--></th>
            <th id="itemCycle" class="order_item ketou" data-name="item.item_cycle" style="">期限
                <!--<span class="order"></span>--></th>
